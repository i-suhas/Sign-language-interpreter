...
class Application:
    ...
    def __init__(self):
        ...
        self.T.config(text=" Beyond Gestures 🖐️ ", font=("Times New Roman", 28, 'bold'))
        ...
        self.T1.config(text="Character :", font=("Times New Roman", 25, "bold"))

        self.panel5 = tk.Label(self.root)  # Sentence
        self.panel5.place(x=260, y=633)

        self.T3 = tk.Label(self.root)
        self.T3.place(x=10, y=632)
        self.T3.config(text="Sentence :", font=("Times New Roman", 25, "bold"))
        ...
        self.clear.place(x=1170, y=550)
        self.clear.config(text="Clear", font=("Minion", 10), wraplength=100, command=self.clear_fun)
