...
cv2.imwrite("C:\\Users\\PycharmProjects\\pythonProject\\white.jpg",white)


while True:
    try: #capture frame and flip
        ...
        if hands:
            ...
            x, y, w, h = hand['bbox']
            image = frame[y - offset:y + h + offset, x - offset:x + w + offset]
            white = cv2.imread("C:\\Users\\PycharmProjects\\pythonProject\\white.jpg")
            # img_final=img_final1=img_final2=0
